...
func (_m *RepositoryMock) Get(id string) (Product, error) {
	ret := _m.Called(id)
...
func (_c *Repository_Get_Call) Return(_a0 Product, _a1 error) *Repository_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

// GetAll provides a mock function with given fields:
func (_m *RepositoryMock) GetAll() ([]Product, error) {
	ret := _m.Called()

	var r0 []Product
	if rf, ok := ret.Get(0).(func() []Product); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]Product)
...
func (_c *Repository_GetAll_Call) Return(_a0 []Product, _a1 error) *Repository_GetAll_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

// GetAllByName provides a mock function with given fields: name
func (_m *RepositoryMock) GetAllByName(name string) ([]Product, error) {
	ret := _m.Called(name)
...
//  - name string
func (_e *Repository_Expecter) GetAllByName(name interface{}) *Repository_GetAllByName_Call {
	return &Repository_GetAllByName_Call{Call: _e.mock.On("GetAllByName", name)}
}

func (_c *Repository_GetAllByName_Call) Run(run func(name string)) *Repository_GetAllByName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *Repository_GetAllByName_Call) Return(_a0 []Product, _a1 error) *Repository_GetAllByName_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *RepositoryMock) Post(p Product) (Product, error) {
	ret := _m.Called(p)
...
func (_c *Repository_Post_Call) Run(run func(p Product)) *Repository_Post_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(Product))
	})
	return _c
...
func (_c *Repository_Post_Call) Return(_a0 Product, _a1 error) *Repository_Post_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
